...
export const ROLE_ICON_FLEX = (
    <svg id="role_flex" viewBox="0 0 64 64" width="100%" height="100%">
...
export const ROLE_ICON_SUPPORT = (
    <svg id="role_support" viewBox="0 0 64 64" width="100%" height="100%">
...
export const ROLE_ICON_OFFENSE = (
    <svg id="role_offense" viewBox="0 0 64 64" width="100%" height="100%">
        <rect x="12" y="49.3" width="10.2" height="5.61" />
        <path d="M22.2,19.1a10.2,10.2,0,0,0,0-1c-.8-6.9-5.1-9-5.1-9s-4.3,2.1-5.1,9c0,.3,0,1,0,1V45.4H22.2Z" />
        <rect x="26.9" y="49.3" width="10.2" height="5.61" />
        <path d="M37.1,19.1a10.2,10.2,0,0,0,0-1C36.3,11.2,32,9,32,9s-4.3,2.1-5.1,9c0,.3,0,1,0,1V45.4H37.1Z" />
        <rect x="41.8" y="49.3" width="10.2" height="5.61" />
        <path d="M52,19.1s0-.8,0-1c-.8-6.9-5.1-9-5.1-9s-4.3,2.1-5.1,9c0,.3,0,1,0,1V45.4H52Z" />
    </svg>
);
export const ROLE_ICON_TANK = (
    <svg id="role_tank" viewBox="0 0 64 64" width="100%" height="100%">
